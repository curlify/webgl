...
(function() {
  ...
  var video = (function() {
    ...
    console.log("initialize video module")
    ...
    return {
      new : function(source) {
        ...
        video.glProgram = quad.default_program.getProgram()
        ...
        if (zipfile != null && source.slice(0, 4) != "http" ) {
          var zipEntry = zipfile.file(source)
          console.log("video.source zip",zipEntry,source,zipfile)
