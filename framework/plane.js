...
plane.new = function(ident,cols,rows,width,height) {
  ...
  instance.updateModelMatrix = function() {
    ...
    mat4.scale(this.quadModelMatrix,vec3.create([(this.size.width)/multiplier,(-this.size.height)/multiplier*1/ysize,1]));
  };
