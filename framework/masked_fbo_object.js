...
(function() {
  ...
  var fbo_object = curlify.getModule("fbo_object")

  var masked_fbo_object = (function() {

    console.log("initialize masked_fbo_object module")
    ...
    return {
      ...
      new : function(identifier,mask,w,h,disable_alpha) {

        var gl = curlify.localVars.gl
        
        var instance = fbo_object.new(identifier,w,h,disable_alpha);
        instance.identifier = "masked_fbo_object : "+identifier+" : "+mask
  ...
  curlify.module("masked_fbo_object",masked_fbo_object)
