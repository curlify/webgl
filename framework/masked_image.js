...
var masked_image_program = {
  ...
  loadProgram : function() {
    ...
    this.glProgram = loadProgram(gl, [vertexShader, fragmentShader], ["a_position","a_tex_coordinate"], ["u_texture","u_mask_texture","u_alpha","u_model","u_view","u_projection"]);

  }
}

var masked_image = function(source,mask) {
  ...
  instance.mask = mask
  instance.glProgram = masked_image_program.getProgram()
...
masked_image.new = function(source,mask) {
  return new masked_image(source,mask)
}
