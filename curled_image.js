...
curled_image.new = function( source ) {
  ...
  curl.randomcurl = function() {
    ...
    curl.pressStart = {x:screenWidth/2,y:screenHeight/2}
    curl.pointerPos = {x:screenWidth/2,y:screenHeight/2}
    curl.anim.animate( curl.pointerPos, {x:screenWidth/2-curlify.getRandom(90,100),y:screenHeight/2-curlify.getRandom(100,150),time:1000,ease:animator.inOutQuad,onComplete:curl.resetcurl})
  }
