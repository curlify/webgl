...
var image = function(source) {
  ...
  if (image_program == null) {
    ...
    image_program.buffer.itemSize = 3;
  ...
  image.render = function() {
    ...
    //gl.bindTexture(gl.GL_TEXTURE_2D, image.texture)
    ...
    gl.vertexAttribPointer(image_program.a_position_handle, image_program.buffer.itemSize, gl.FLOAT, false, 0, 0);
    gl.vertexAttribPointer(image_program.a_tex_coordinate_handle, image_program.buffer.itemSize, gl.FLOAT, false, 0, 0);
